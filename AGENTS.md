...
| Branch | Contains |
|--------|----------|
| `main` | Spectral merge engine, TUI ensemble picker, aux checkpoint blending, degraded README/AGENTS, stfl configs, noise augmentation disabled. |
| `diagnostic/revert-training-step` | Training step revert, TF32 disabled, AMP restoration, noise disabled, cherry-picked 0.3.4.1 (ensemble code). |

The diagnostic branch contains the four training fixes that have not yet been validated. If they resolve the stfl regression, they will be merged to main.
